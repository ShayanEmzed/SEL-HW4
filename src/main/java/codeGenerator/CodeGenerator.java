...
import Log.Log;
import codeGenerator.AddressStrategy.ImidiateAddress;
import codeGenerator.AddressStrategy.IndirectAddress;
...
//    }
    ...
    public void call() {
        ...
        try {
            ...
            symbolTable.incrementMethodIndex(className, methodName);
...
//        String className = symbolStack.pop();
        try {
            ...
            symbolTable.incrementMethodIndex(callStack.peek(), methodName);
            varType t = varType.Int;
            switch (s.type) {
                case Bool:
                    t = varType.Bool;
