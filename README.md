...
## بخش تئوری
### سوال اول
- کد تمیز: کد تمیز (clean code) به کدی گفته می‌شود که به راحتی قابل فهم و تغییر است. بدین ترتیب تمامی کلاس‌ها و ارتباطات بین آنها به نوعی تعریف شده که برای خواننده کد مفهوم بوده و باعث ایجاد maintainability می‌شود.
- بدهی فنی: بدهی فنی یا technical debt نتیجه الویت دادن به سریع‌تر رساندن کد به مشتری است. بدین ترتیب، به علت تخصیص ندادن وقت لازم از سمت توسعه‌دهنده‌ها برای شناسایی کامپوننت‌ها و روابط، در آینده بیزینس مدنظر ملزم به ریفکتور و پرداخت بدهی ایجاد شده است چرا که کد کنونی غیرقابل فهم و unmaintable است.
- بوی بد: code smells نشان‌دهنده مشکلاتی هستند که در زمان ریفکتور کردن با آنها مواجه می‌شویم. معمولا شناسایی بوی بد کد آسان است اما می‌تواند بیانگر مشکلات عمیق در کد نیز باشد.
### سوال دوم
۱. بوی بد bloater:‌ مواجه با کلاس‌ها یا متد‌هایی که بسیار بزرگ هستند به نوعی که کار کردن با آنها دشوار است. این کلاس‌ها معمولا با گذر زمان و تکامل برنامه بزرگ شده و به حجم آنها اضافه می‌شود.  
۲. بوی بد object-orientation abusers: استفاده نادرست یا ناقص از مفاهیم شیء‌گرا.  
۳. بوی بد change preventers: برای تغییر یک جای کد، باید جاهای دیگر را تغییر داد. این بوی بد توسعه کد را سخت و هزینه‌بر خواهد کرد.  
۴. بوی بد dispensables: قسمت‌های غیرضروری کد که نبودن آنها موجب داشتن یک کد تمیزتر، قابل فهم‌تر و با کارایی بیشتر می‌شود.  
۵. بوی بد couplers: زمانی که coupling و وابستگی بین کلاس‌ها بیش از حد معقول است.  
### سوال سوم
- در دسته چهارم، dispensables زیرا کلاس یا کدی داریم که به توجه کافی احتیاج ندارد (مثلا به خاطر اینکه بسیار کوچک است).
- برای کامپوننت‌هایی که بسیار کم استفاده می‌شوند می‌توان از inline class استفاده کرد. همچنین برای زیرکلاس‌هایی با متدهای بسیار کم می‌توان Collapse Hierarchy را امتحان کرد.
- زمانی که یک lazy class برای نشان دادن و بیان‌ کردن توسعه‌های آینده به کار رفته است.
